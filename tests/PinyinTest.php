...
class PinyinTest extends TestCase
{
    ...
    /** @test */
    public function converting_only_chinese_to_pinyin()
    {
    ...
    /** @test */
    public function it_uses_the_most_common_pinyin()
    {
    ...
    /** @test */
    public function converting_chinese_with_english_to_pinyin()
    {
    ...
    /** @test */
    public function converting_chinese_that_has_english_in_brackets()
    {
    ...
    /** @test */
    public function converting_when_chinese_is_contained_in_something()
    {
    ...
    /** @test */
    public function converting_should_normalize_punctuation()
    {
    ...
    /** @test */
    public function converting_should_handle_punctuation_well()
    {
    ...
    /** @test */
    public function converting_handles_strange_things()
    {
    ...
    /** @test */
    public function converting_handles_urls_well()
    {
    ...
    /** @test */
    public function converting_handles_spaces_well()
    {
    ...
    /** @test */
    public function it_returns_the_input_string_if_no_chinese_to_convert()
    {
        $input = [
            ' ，。！？：‘’，。！？：‘’',
